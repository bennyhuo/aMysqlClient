...
public class SqlBuilder {
	...
	private static String getCountSqlByTableName(String tableName){
	...
	public static String getCountSQLByWhere(Class<?> clazz,String strWhere){
		TableInfo table=TableInfo.get(clazz);
		
		StringBuffer strSQL = new StringBuffer(getCountSqlByTableName(table.getTableName()));
